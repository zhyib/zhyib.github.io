...
时代变了，ESLint 更新到`9.x`之后，[废弃了部分对格式的规则](https://eslint.org/docs/head/use/rule-deprecation)，只保留了对语法的校验。所以如果需要 ESLint 自动化格式，需要安装额外的插件以及配置。高版本配置请参考[这篇文章](/20241230/20241230-ESLint9的配置)
